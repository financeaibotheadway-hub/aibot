...
`Dockerfile`, `cloudbuild.yaml` — деплой (якщо використовується Cloud Run / Cloud Build)
...
Якщо потрібно — додайте сюди внутрішній контакт команди, канал Slack або інструкції для онбордингу.
